...
import { Activity, LayoutPanelLeft, Users, Menu, User as UserIcon, LogOut, Bug } from "lucide-react"
...
const studentNav = [{ title: "ECG Simulation", href: "/ecg", icon: Activity }]

const teacherNav = [
  { title: "ECG Simulation", href: "/teacher/simulations", icon: Activity },
  { title: "Students & Analytics", href: "/teacher/dashboard", icon: Users },
]
...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "sticky top-0 h-screen border-r border-border bg-card/60 backdrop-blur-sm p-4 flex flex-col transition-all duration-200",
